package cn.lanqiao.bankproject.common;
...
public enum ResultCodeEnum {
    ...
    THE_PASSWORD_IS_DIFFERENT_FOR_THE_TWO_TIMES(208, "两次密码不一致"),
    ARRAY_IS_EMPTY(209, "数组为空"),
    ...
    ADMIN_ACCOUNT_ERROR_PASSWORD(307, "密码错误"),
    ADMIN_ACCOUNT_DISABLED_ERROR(308, "该用户已被禁用"),
    ADMIN_ACCESS_FORBIDDEN(309, "无访问权限"),
    ADMIN_APARTMENT_DELETE_ERROR(310, "请先删除下面的房间信息"),
    ID_FOR_NULL(311, "ID为null"),

    APP_LOGIN_AUTH(501, "未登陆"),

    APP_LOGIN_PHONE_EMPTY(502, "手机号码为空"),
    APP_LOGIN_PHONE_EMPTY_NOT(502, "手机号码不合法"),

    APP_LOGIN_CODE_EMPTY(503, "验证码为空"),
    APP_LOGIN_USERNAME(508, "账号为空"),

    APP_SEND_SMS_TOO_OFTEN(504, "验证法发送过于频繁"),

    APP_LOGIN_CODE_EXPIRED(505, "验证码已过期或验证码非法"),

    APP_LOGIN_CODE_ERROR(506, "验证码错误"),

    APP_ACCOUNT_DISABLED_ERROR(507, "该用户已被禁用"),

    INCORRECT_ID_CODE(509, "账号或身份码不正确"),
    INCORRECT_ID_CODE_USERNAME(510, "账号信息为空"),

    TOKEN_EXPIRED(601, "token过期"),

    TOKEN_INVALID(602, "token非法"),
    PARAMETER_ANOMALY(700, "传入参数异常");
